...
namespace XamlStaticHelperNamespace {
    ...
    internal class _XamlStaticHelper {
        ...
        private static System.Collections.Generic.IList<System.Reflection.Assembly> LoadAssemblies() {
            ...
            assemblyList.Add(Load("FlaUI.Core, Version=3.2.0.0, Culture=neutral, PublicKeyToken=null"));
            assemblyList.Add(Load("FlaUI.UIA3, Version=3.2.0.0, Culture=neutral, PublicKeyToken=null"));
            assemblyList.Add(Load("Interop.UIAutomationClient, Version=10.0.18362.0, Culture=neutral, PublicKeyToken" +
                        "=null"));
